...
from app_api.src.presentation.schemas.ava_profile import AvaProfileIn, AvaProfileOut
from app_api.src.infrastructure.persistence.models.ava_profile import AvaProfile
from app_api.src.application.services.realtime_session import (
    build_session_config,
    build_system_prompt,
)
from app_api.src.infrastructure.external.text_to_speech import (
    VoicePreviewError,
    synthesize_preview,
)
from app_api.src.infrastructure.database.session import get_session
from app_api.src.domain.value_objects.ava_profile import (
